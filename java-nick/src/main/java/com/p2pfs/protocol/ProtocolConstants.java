...
public final class ProtocolConstants {
    ...
    public static final int DEFAULT_PORT = 6767;          // mDNS advertises actual port; this is the preferred one
    public static final String NATIVE_HKDF_INFO = "session key"; // Go/Python use this; Java uses "p2p-session"
